...
public class CountMoney 
{
	public static void main(String[] args)
	{
		 ...
		 */
		//corrected inefficiency 
		int parsedCents = Integer.parseInt(cents);
		int quarters = parsedCents/25;
		int dimes = parsedCents-(quarters*25))/10;
		int nickels = parsedCents-(dimes*10)-(quarters*25))/5;
		int pennies = parsedCents-(nickels*5)-(dimes*10)-(quarters*25))/1;
